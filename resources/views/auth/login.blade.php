<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <div class="mt-6">
            <a href="https://ticomperu.com/login/facebook/redirect" class="btn btn-primary">Ingresar con Facebook</a>
            <a href="/login/google/redirect" class="btn btn-danger">Ingresar con Google</a>
        </div>
    </x-jet-authentication-card>
</x-guest-layout>
